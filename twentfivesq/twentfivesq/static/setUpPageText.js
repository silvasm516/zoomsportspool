var One = "First: Set up your grid(s) on this page. Set up each grid, completely, one at a time. Each grid represents a separate pool.\
 More than one grid may refer to the same ball game."

var Two = "Second: Start by selecting your teams from the menus above.\If your team is not included among the options, use the 'other  custom' fields for that team.\
 After selecting your teams, press the green 'submit teams' button."
 
var Three = "Third: Complete the fields below. Enter the game date and time keeping in mind that the random row/column \
 numbers will be assigned 24 hours previously. The final payout will be either for the end of the fourth quarter score,\
or the final score of the game if different due to over-time. Afterwards press the\
 'submit grid' button."
